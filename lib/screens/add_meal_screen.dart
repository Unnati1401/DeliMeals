...
class _AddMealState extends State<AddMeal> {
  ...
  String setAffordability() {
    if (_isAffordable) return 'Affordable';
    if (_isPricey) return 'Pricey';
    return 'Luxurious';
  }

  String setComplexity() {
    if (_isSimple) return 'Simple';
    if (__isChallenging) return 'Challenging';
    return 'Hard';
  }

  @override
  void didChangeDependencies() {
    for (int i = 0; i < 10; i++) categoriesSelected.add(false);
  ...
  void _submitForm(BuildContext ctx) {
    ...
    for (int i = 1; i <= 10; i++) {
      if (categoriesSelected[i - 1] == true) listToPass.add('c' + i.toString());
    }
                ...
                child: ListView(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value.isEmpty) return 'Please specify a title.';
                        return null;
                      },
                    ),
                    SizedBox(
                    ...
                    TextFormField(
                      ...
                      onFieldSubmitted: (_) {
                        FocusScope.of(context)
                            .requestFocus(_numberOfstepsFocusNode);
                      },
                      validator: (value) {
                    ...
                    TextFormField(
                      ...
                      onFieldSubmitted: (_) {
                        FocusScope.of(context)
                            .requestFocus(_numberOfingredientsFocusNode);
                      },
                      validator: (value) {
                        if (value.isEmpty) return 'Please enter a value.';
                    ...
                    Text(
                      'Select affordability of the meal :',
                      style: TextStyle(
                        fontSize: 20,
                        foreground: Paint()
                          ..style = PaintingStyle.stroke
